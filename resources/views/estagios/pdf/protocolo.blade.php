...
<body>
    ...
    <table class="table">
        ...
        <tr>
            <td colspan="2"><h1 style="text-align: center; margin:30px 0;">Inscrição no Programa Municipal de Estágio - Edital Nº 001/2025</h1></td>
        </tr>
        ...
        <tr>
            <td colspan="2">
                <ul style="list-style: none; list-style-position: outside; margin-top:30px;">
                    ...
                    <li><strong>ENSINO SUPERIOR</strong></li>
                </ul>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2">
                ...
                <p style="margin-top: 10px; text-align: justify; font-size: 18px; line-height: 30px; font-weight: bold;">
                    ATENÇÃO: Leia o Edital Nº 001/2025 para preparar a documentação exigida pelo Processo Seletivo. O prazo de entrega é até 16:30 do dia 12/02/2025.
                </p>
            </td>
        </tr>
