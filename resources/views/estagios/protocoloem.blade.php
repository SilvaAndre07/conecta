        ...
        <div class="card-body">
            ...
            <div class="shadow-sm rounded my-4 p-4">
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        ...
                        <p class="m-1">Tipo da Vaga: <strong>ENSINO MÉDIO</strong></p>
            ...
            <div class="row">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-warning me-md-2" id="btSave" type="button" onclick="window.open('{{route('estagios.pdf.protocoloEM')}}','_blank'); return false;">Imprimir Protocolo</button>
                    <button class="btn btn-primary me-md-2" id="btSave" type="button" onclick="location.href='{{route('estagios.finish')}}';">Concluir</button>
                </div>
            </div>
