        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-warning me-md-2" id="btSave" type="button" onclick="window.open('{{route('estagios.pdf.protocolo')}}','_blank'); return false;">Imprimir Protocolo</button>
