...
<div class="col-xl-10 mx-auto">
    ...
    <div class="card mt-4">
        <div class="card-header painel-card-header"><strong>Programa Municipal de Estágio - Ensino Superior</strong></div>
        <div class="card-body">
            <form action="{{route('estagios.createNovoEdital')}}" method="post" id="formPre">
            @csrf()
            <div class="shadow-sm rounded my-4 p-4">
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        ...
                        <p class="m-1"><strong>Processo Seletivo - Edital nº 002/2025</strong> - <a href="/arquivos/Edital_Estagio_002-2025.pdf" target="_blank">Acesse o Documento Aqui</a></p>
                    ...
                    <div class="col-xl-5">
                        <div class="mb-3 ">
                            ...
                            <select class="form-select select-uf" name="txtCNHSerie" id="txtCNHSerie" aria-label="Selecione...">
                                ...
                                <option value="A" {{ "A" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA A</option>
                                <option value="B" {{ "B" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA B</option>
                                <option value="C" {{ "C" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA C</option>
                                <option value="D" {{ "D" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA D</option>
                                <option value="E" {{ "E" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA E</option>
                                <option value="AB" {{ "AB" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA AB</option>
                                <option value="AC" {{ "AC" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA AC</option>
                                <option value="AD" {{ "AD" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA AD</option>
                                <option value="AE" {{ "AE" === old('txtCNHSerie') ? 'selected' : '' }}>CATEGORIA AE</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-xl-3">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-check mt-4">
                            ...
                            Ao manifestar o registro no Programa de Estágio, o Titular consente e concorda que a Prefeitura Municipal de Assaí, CNPJ nº 76.290.709/0001-30, com sede na Avenida Rio de Janeiro, 720 - Centro,
