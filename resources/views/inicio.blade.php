...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('scripts/owlcarousel/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('scripts/owlcarousel/assets/owl.theme.default.min.css') }}">
...
<body>
    <header>
        ...
        <nav class="text-center shadow">
            <img src="{{ asset('img/logo_conecta.png') }}" alt="Conecta Assaí">
        </nav>
                ...
                <div class="row text-center">
                    <div class="col-sm-3 mb-3 mb-sm-0 mx-auto">
                        <div class="card w-100">
                            <img src="{{ asset('img/programa-estagio.jpg') }}" class="card-img-top" alt="Programa de Estágio">
                            <div class="card-body">
    ...
    <script src="{{ asset('scripts/owlcarousel/owl.carousel.min.js') }}"></script>
